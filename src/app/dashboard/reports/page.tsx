...
import { useAuthStore, useReportStore, useAppointmentStore, useStaffStore, useVehicleStore, type ReportFilters } from '@/lib/store'
import {
    Card,
    CardContent,
    CardHeader,
                    ...
                    <CardContent>
                            ...
                            <Card>
                                <CardContent className="pt-6">
                                    <div className="text-center">
                                        ...
                                        <h3 className="text-3xl font-bold mt-1">{reportData.totalAppointments}</h3>
                                    </div>
                                </CardContent>
                            </Card>
                            <Card>
                                <CardContent className="pt-6">
                                    <div className="text-center">
                                        ...
                                        <h3 className="text-3xl font-bold mt-1 text-green-600">{reportData.completedAppointments}</h3>
                                    </div>
                                </CardContent>
                            </Card>
                            <Card>
                                <CardContent className="pt-6">
                                    <div className="text-center">
                                        ...
                                        <h3 className="text-3xl font-bold mt-1 text-blue-600">{reportData.pendingAppointments}</h3>
                                    </div>
                                </CardContent>
                            </Card>
                            <Card>
                                <CardContent className="pt-6">
                                    <div className="text-center">
                                        ...
                                        <h3 className="text-3xl font-bold mt-1 text-red-600">{reportData.cancelledAppointments}</h3>
                                    </div>
                                </CardContent>
                            </Card>
                        </div>
                        ...
                        <Table>
                            ...
                            <TableBody>
                                {isLoading ? (
                                    <TableRow>
                                        <TableCell colSpan={6} className="text-center py-6">加载中...</TableCell>
                                    </TableRow>
                            ...
                            <div className="mt-4 flex justify-between items-center">
                                ...
                                <Pagination>
                                    <PaginationContent>
                                        ...
                                        )).slice(Math.max(0, page - 3), Math.min(getTotalPages(), page + 2))}
