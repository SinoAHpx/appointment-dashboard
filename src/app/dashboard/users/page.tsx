...
import { useAuthStore, useCustomerStore, type CustomerUser } from '@/lib/store'
import {
    Card,
    CardContent,
    CardHeader,
...
export default function UsersPage() {
    ...
    const handleUpdateCustomer = async () => {
        ...
        // 表单验证
        if (!editingCustomer.name || !editingCustomer.phone || !editingCustomer.email || !editingCustomer.address) {
            toast.error('请填写所有必填项')
            return
        }
